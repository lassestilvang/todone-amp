    ...
    <div className="space-y-6">
      ...
      {activeTab === 'import' && (
        <div className="space-y-4">
          ...
          {importSuccess && (
            <div className="p-4 bg-semantic-success-light border border-semantic-success rounded-lg">
              <p className="text-semantic-success font-medium">✓ Data imported successfully!</p>
          ...
          {importError && (
            <div className="p-4 bg-semantic-error-light border border-semantic-error rounded-lg">
              <p className="text-semantic-error font-medium">✗ Import failed</p>
              <p className="text-sm text-semantic-error mt-1">{importError}</p>
            </div>
          )}
          ...
          <div className="bg-semantic-info-light border border-semantic-info rounded-lg p-4">
            <h4 className="font-medium text-semantic-info mb-2">Import Tips</h4>
      ...
      {activeTab === 'templates' && (
        <div className="space-y-4">
          ...
          {templateApplySuccess && (
            <div className="p-4 bg-semantic-success-light border border-semantic-success rounded-lg">
              <p className="text-semantic-success font-medium">✓ Template applied successfully!</p>
              <p className="text-sm text-semantic-success mt-1">Your new project has been created.</p>
            </div>
          )}

          {templateApplyError && (
            <div className="p-4 bg-semantic-error-light border border-semantic-error rounded-lg">
              <p className="text-semantic-error font-medium">✗ Failed to apply template</p>
              <p className="text-sm text-semantic-error mt-1">{templateApplyError}</p>
            </div>
          )}
              ...
              <div className="space-y-3 pt-4 border-t">
                <label className="block">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-border rounded-lg focus:ring-2 focus:ring-focus focus:border-transparent outline-none"
                  />
                </label>
