...
export const SettingsView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-surface-secondary bg-pattern-grid">
      <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 bg-gradient-subtle">
        {/* Header */}
        <div className="mb-8">
                  ...
                  <div className="absolute top-full mt-1 w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg z-10 max-h-64 overflow-y-auto">
                    {LANGUAGES.map((lang) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-2 hover:bg-hover-subtle flex items-center gap-2"
                      >
