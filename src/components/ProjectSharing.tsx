    ...
    <div className="flex flex-col gap-4 rounded-lg border border-gray-200 bg-white p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-medium text-gray-900">Project Sharing</h3>
        </div>
        {onClose && (
      ...
      {projectShares.length > 0 ? (
        <div className="flex flex-col gap-3 border-t border-gray-200 pt-3">
          <p className="text-xs font-medium text-gray-700">Collaborators</p>
          {projectShares.map((share) => {
            const s = share as { id: string; email: string; role: string }
            return (
            <div key={s.id} className="flex items-center justify-between rounded bg-gray-50 p-3">
          ...
          {!showInvite ? (
            ...
            <div className="flex flex-col gap-2">
              <input
                ...
                className="rounded border border-gray-300 px-3 py-2 text-sm text-gray-900 placeholder-gray-500"
              />
      ...
      <div className="flex flex-col gap-2 border-t border-gray-200 pt-3">
        <p className="text-xs font-medium text-gray-700">Roles & Permissions</p>
