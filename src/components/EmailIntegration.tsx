  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="rounded-lg border border-gray-200 p-4">
        ...
        <div className="mt-4 space-y-3">
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-3">
            <p className="text-xs font-medium text-gray-700">Your Forwarding Address</p>
            <div className="mt-2 flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-3 py-2 hover:bg-gray-50"
              >
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-3">
              ...
              <span className="text-sm text-gray-700">Parse email body as description</span>
            </label>
            <label className="flex items-center gap-3">
              <input type="checkbox" defaultChecked className="h-4 w-4" />
              <span className="text-sm text-gray-700">Extract due dates from email content</span>
            </label>
            <label className="flex items-center gap-3">
              <input type="checkbox" defaultChecked className="h-4 w-4" />
              <span className="text-sm text-gray-700">Automatically assign labels</span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-lg border border-gray-200 p-4">
        ...
        <p className="mt-2 text-sm text-gray-600">Receive email reminders before task due dates</p>
      ...
      <div className="rounded-lg border border-gray-200 p-4">
        ...
        <p className="mt-2 text-sm text-gray-600">Get a daily email summary of your tasks</p>
        ...
        <div className="mt-3 space-y-2">
          ...
          <label className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-700">Upcoming (next 7 days)</span>
          </label>
        </div>
      </div>
      ...
      <button
        disabled={isLoading}
        className="w-full flex items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 font-medium text-gray-900 hover:bg-gray-50 disabled:opacity-50"
      >
