    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-4 border-b border-border">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-2xl font-bold text-content-primary">Upcoming</h2>
            <p className="text-sm text-content-tertiary mt-1">Next 7 days</p>
          </div>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {groupedTasks.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <p className="text-content-tertiary text-sm">{advancedQuery ? 'No tasks match this filter' : 'No upcoming tasks'}</p>
          </div>
        ) : (
