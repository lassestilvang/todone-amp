          ...
          >
            ...
            <div className="flex gap-1 flex-shrink-0">
              <button
                ...
                className="p-2 text-semantic-info hover:bg-semantic-info-light-hover rounded"
              >
              ...
              <button
                ...
                title="Delete query"
                className="p-2 text-semantic-error hover:bg-semantic-error-light-hover rounded"
              >
