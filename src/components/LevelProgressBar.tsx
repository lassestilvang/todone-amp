    ...
    return (
      <div className={cn('flex items-center gap-2', className)}>
        <div className="flex items-center gap-1">
          ...
          <span className="text-xs font-semibold text-gray-700 dark:text-gray-300 capitalize">{currentLevel}</span>
        </div>
        ...
        <span className="text-xs text-gray-500 dark:text-gray-400">{currentKarma}</span>
      </div>
    )
  }
    ...
    <div className={cn('space-y-3 rounded-lg border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800', className)}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-900 dark:text-white capitalize">{currentLevel}</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">{currentKarma} karma points</p>
          </div>
        </div>
        <div className="flex items-center gap-1">
          <Zap className="h-4 w-4 text-yellow-500" />
          <span className="text-sm font-bold text-gray-900 dark:text-white">{currentKarma}</span>
        </div>
      </div>
      ...
      {currentLevel !== 'enlightened' && (
        <>
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              <p className="text-xs font-medium text-gray-600 dark:text-gray-400">Progress to next level</p>
          ...
          <div className="flex items-center gap-2 rounded-md bg-gray-50 p-2 dark:bg-gray-700">
            ...
            <div className="text-xs text-gray-600 dark:text-gray-400">
              ...
              <p className="text-gray-500 dark:text-gray-400">{nextThreshold} karma points</p>
            </div>
          </div>
        </>
      )}
